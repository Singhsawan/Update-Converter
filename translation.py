...
I Am %s , Bulk Link Converter Bot. I Can Convert Links Directly From Your urllinkshort.in Account,
...
If You Want Any **Other Shortner** Link Converter Bot Instead Of urllinkshort.in than **contact** at 👉 @J_shree_ram (all **shortners** support available.)
''' % BASE_SITE
...
`📢 Support:` [SUPPORT](https://t.me/bot_channel_011)
"""
...
START_MESSAGE_REPLY_MARKUP = InlineKeyboardMarkup([[InlineKeyboardButton('ᴄᴏɴɴᴇᴄᴛ ᴜʀʟʟɪɴᴋꜱʜᴏʀᴛ ᴀᴘɪ ↗️', url=f'https://{BASE_SITE}/member/tools/api')]])
